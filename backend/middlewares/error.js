...
const errorHandler = (err, req, res, next) => {
  ...
  // checks error for duplicate keys, for e.g if the name of email is unique mongoose will give this error if name repeats:
  if (err.code === 11000) {
    const message = `User already exist with this email, please enter another email or login`;
